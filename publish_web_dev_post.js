...
// Função para publicar o post sobre desenvolvimento web
async function publishWebDevPost() {
  try {
    console.log('🚀 Publicando post sobre desenvolvimento web...');
